...
class ImageDataGenerator(object):
    ...
    # Arguments
        ...
        rescale: rescaling factor. If None or 0, no rescaling is applied,
            otherwise we multiply the data by the value provided (before applying
            any other transformation).
        dim_ordering: 'channels_first' or 'channels_last'. In 'channels_first' mode, the channels dimension
    ...
    def __init__(self,
        ...
        self.__sync_seed = self.config['seed'] or np.random.randint(0, 2147483647)
    ...
    def process(self, x, rng=np.random.RandomState()):
        # get next sync_seed
